...
@XmlType(name = "Hotel", namespace = "http://xml.netbeans.org/schema/hotelschema", propOrder = {
    "name",
    "booknumber",
    "city",
    "reservationService",
...
@XmlSeeAlso({
    wsdl.ItineraryComplexType.HotelListRoot.HotelList.class
})
public class Hotel {
    ...
    @XmlElement(name = "ReservationService", namespace = "http://xml.netbeans.org/schema/hotelschema", required = true)
